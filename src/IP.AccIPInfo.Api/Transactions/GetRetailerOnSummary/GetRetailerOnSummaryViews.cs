...
public sealed record GetRetailerOnSummaryQuery(GetRetailerOnSummaryQueryRequest Request) :
    IQuery<GetRetailerOnSummaryResponse>;

public sealed class GetRetailerOnSummaryQueryRequest :
    QueryBaseFilter,
    IQuery<GetRetailerOnSummaryResponse>
{
...
public sealed class GetRetailerOnSummaryResponse(
